...
class SegModule:    # U2Net + HSNet
    ...
    def RGBD_sub_callback(self, image_msg, depth_msg):
        if self.target_id > 0:
            ...
            trial = 1
            cv2.imwrite("/home/robot/IROS_Experiment/access_video/{0}/image_{1}.png".format(str(self.target_id), str(trial)), img)
            cv2.imwrite("/home/robot/IROS_Experiment/access_video/{0}/depth_{1}.png".format(str(self.target_id), str(trial)), depth)
            cv2.imwrite("/home/robot/IROS_Experiment/access_video/{0}/masked_image_{1}.png".format(str(self.target_id), str(trial)), masked_image)
            cv2.imwrite("/home/robot/IROS_Experiment/access_video/{0}/segmented_{1}.png".format(str(self.target_id), str(trial)), segmented_image)
